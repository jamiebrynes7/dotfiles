...
- [ ] **Step 1: Add `async-trait` to `crates/beansd-rpc/Cargo.toml`**
...
- [ ] **Step 2: Create `crates/beansd-rpc/src/types.rs`**
...
- [ ] **Step 3: Create `crates/beansd-rpc/src/server.rs`**
...
- [ ] **Step 4: Update `crates/beansd-rpc/src/lib.rs`**
