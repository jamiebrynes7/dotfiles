...
updated_at: 2026-05-10T15:00:59Z
...
- [ ] **Step 1: Create `crates/beansd/src/daemon.rs`**
...
- [ ] **Step 2: Create `crates/beansd/src/handler.rs`**
...
- [ ] **Step 3: Delete `crates/beansd/src/control.rs`**
...
- [ ] **Step 4: Update `crates/beansd/src/main.rs`**
...
- [ ] **Step 5: Update `crates/beansd/src/run.rs`**
...
- [ ] **Step 6: Update `crates/beansd/src/launcher.rs`**
