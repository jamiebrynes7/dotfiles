...
updated_at: 2026-06-04T10:10:46Z
...
- [ ] **Step 1: Add the option to `home/programs/zsh.nix`**
...
- [ ] **Step 2: Wire it into `home.sessionPath` in `home/programs/zsh.nix`**
...
- [ ] **Step 3: Migrate `home/programs/claude-code/default.nix`**
